...
public class HomePager extends BasePager {
    public static final String CACHE_HOME_PAGE_DATA= "cache_home_page_data";
    ...
    public void initData() {
        ...
        View view=View.inflate(context, R.layout.home_page,null);
        initialize(view);
